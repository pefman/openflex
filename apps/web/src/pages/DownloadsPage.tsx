...
import { moviePath, timeAgo } from '@/lib/utils'
    ...
    <div className="flex items-start gap-4 px-4 py-3">
      <div className="flex-1 min-w-0">
        ...
        {download.movieId != null ? (
          <Link to={moviePath(download.title, download.movieId)} className="text-sm font-medium truncate block hover:text-primary">{download.title}</Link>
        ) : (
