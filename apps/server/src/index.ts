...
import { startImdbSyncJob } from './services/imdbListSyncJob.js'
...
async function seedIndexers() {
  if (process.env.SEED_DEFAULT_INDEXER !== 'true') return
  ...
  log('info', 'startup', 'seeded default NZBGeek indexer (disabled)')
}
