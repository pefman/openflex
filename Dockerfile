...
# pnpm deploy can produce an empty package.json; ensure it is valid ESM config
RUN [ -s /prod/server/package.json ] || echo '{"name":"openflex","version":"0.1.0","type":"module"}' > /prod/server/package.json
